...
%if %{signmodules}
    ...
    cp certs/signing_key.priv signing_key.priv.sign${Flavour:+.${Flavour}}
...
%changelog
* Thu Jul 6 2017 Fathi Boudra <fathi.boudra@linaro.org> [4.12.0-2f8e55b.linaro]
- Update to RPK commit 2f8e55b, based on 4.12.0.
